...
#include "Animation/AnimNotify_SpawnWeapon.h"
#include "Character/RBCharacterBase.h"
#include "Weapon/RBWeaponTypeBase.h"
#include "Interface/RBWeaponFieldAttackInterface.h"

void UAnimNotify_SpawnWeapon::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	...
	{
		RBWeaponFieldAttackInterface->PerformWeaponSummonEffect();
	}
}